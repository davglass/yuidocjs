...
YUI.add('doc-builder', function(Y) {
    ...
    Y.DocBuilder = function(options, data) {
        ...
        if (this.options.parseMarkdown !== false) {
            this.options.parseMarkdown = true;
        }
        this.options.parseMarkdown = false;
    ...
    Y.DocBuilder.prototype = {
        ...
        */
        ...
        /**
        * Parse and item type and link it to a local or remote source
        * @method _parseCrossLink
        * @private
        * @param {String} item The item type to link
        * @param {Boolean} [raw=false] Only return the href and not the wrapped HTML
        */
        ...
        /**
        * List of native types to cross link over to MDC
        * @property NATIVES
        * @type Object
        * @private
        */
        ...
        /**
        * Function to crosslink with from the NATIVES object
        ...
        */
        ...
        /**
        * Mixes remote data with local data and flags it as external for crosslinking
        * @method _mixExternal
        * @private
        */
        ...
        * Fetch external data
        * @method mixExternal
        * @param {Callback} cb Execute when completed
        */
        ...
        */
        files: null,
        /**
        * Holds on to project meta after it's parsed.
        * @property _meta
        * @private
        */
        _meta: null,
        ...
        */
        ...
        /**
        * Formatter for setting up (found at file:line#)
        * @method addFountAd
        * @param {Object} a The json data
        */
                ...
                if (i && i.forEach) {
                    Y.each(i, function(a, k) {
                        ...
                        if (!a.description) {
                            ...
                            a.description = self.markdown(a.description, true, self.defaultTags);
                        }
                        if (a.example) {
                    ...
                    Y.each(i, function(v, k) {
                        ...
                        if (k === 'description' || k === 'example') {
                            if (k1 === 'return') {
                                ...
                                o[k1][k] = self.markdown(v, true, self.defaultTags);
                            }
                        }
                    });
                } else if (k1 === 'description' || k1 === 'example') {
                    o[k1] = self.markdown(i, true, self.defaultTags);
                }
            });
            return o;
        },
        ...
        */
        ...
        /**
        * Renders a module pages HTML
        * @method renderModule
        * @param {Callback} cb Execute when complete
        * @param {Object} data The data to build this page from
        * @param {Object} [layout] Optional layout to use
        */
        ...
        */
        ...
        /**
        * Check if an object has and override property from another
        * @method hasProperty
        * @param {Array} a List of items to check against (classitems)
        * @param {Object} b The Object to compare
        ...
        */
        ...
        /**
        * Merge extended data from other objects into this view
        * @metthod mergeExtends
        * @param {Object} info The object to check extended objects
        * @param {Array} classItems The items to check against.
        */
        ...
        /**
        * Returns the HTML for a class page
        * @method renderClass
        * @param {Callback} cb The callback
        * @param {Object} data The data to build this view with
        * @param {Object} [layout] Optional layout to use
        */
        ...
        */
        ...
        /**
        * Renders the HTML for a file page
        * @method renderFile
        * @param {Callback} cb The callback to execute
        * @param {Object} data The data to use to render the template
        * @param {Object} [layout] An optional layout to use
        */
        ...
        /**
        * Assemble the API JSON data for the autocomplete widget
        * @method writeAPIMeta
        * @param {Callback} cb The callback
        */
        ...
        /**
        * Write out API metadata to a JS file for the Autocomplete
